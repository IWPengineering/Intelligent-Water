...
static char phoneNumber[] = "+17177784498";        // Number for Upside Wireless
...
static char *timeString = "+++CCLK: \"14/07/25,12:55:00+00\"";
...
void main (void) {
    ...
    while(1) { //MAIN LOOP; repeats indefinitely
        ...
        switch (hour / 2) { //organize extaction into 2 hours bins
